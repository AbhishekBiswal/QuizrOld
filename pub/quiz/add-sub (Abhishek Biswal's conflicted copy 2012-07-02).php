<?php
	...
	*/
	...
	$insert = $DBH->prepare("INSERT INTO questions(qid,seq,question,option1,option2,option3,option4,answer,user,dt) VALUES(?,?,?,?,?,?,?,?,?,NOW())");
	$insert->execute(array($qid,$seq,$qQuestion,$qOption1,$qOption2,$qOption3,$qOption4,$qAnswer,$curUser));
	$updatemeta = $DBH->query("UPDATE quizmeta SET questions=questions+1 WHERE id='$qid'");
	echo "Question Added!";
